...
public final class FragmentDashboardBinding implements ViewBinding {
  ...
  private FragmentDashboardBinding(@NonNull LinearLayout rootView, @NonNull TextView textLocation) {
  ...
  public static FragmentDashboardBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentDashboardBinding((LinearLayout) rootView, textLocation);
    }
